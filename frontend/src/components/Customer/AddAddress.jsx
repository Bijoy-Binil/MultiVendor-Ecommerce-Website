    ...
    <>
      ...
      <div className="w-full md:w-3/4 mx-auto md:mx-35 -mt-[20px]  md:-mt-[410px]">
        <form className="w-full max-w-md bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold mb-6 text-center text-gray-800">Add Address</h2>
          ...
          <button
            type="submit"
            className="w-full text-white bg-purple-600 cursor-pointer hover:bg-purple-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
          >
            Add Address
          </button>
        </form>
