...
class ProductListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'category', 'vendor','title','image','slug','tag_list','detail','price','product_ratings','product_images','image' ]
...
class ProductDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        many=True
        model = Product
        fields = ['id', 'category', 'vendor','title','image','demo_url','slug','tag_list','detail','price','product_ratings','product_images','image' ]
...
class OrderSerializer(serializers.ModelSerializer):
    class Meta:
        model = Order
        fields = ['id', 'customer', 'order_time']  # Include necessary fields
